...
public final class CameraXViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<com.example.poseexercise.data.ExerciseAnalysisResult> analysisLiveData = new MutableLiveData<>();

    public MutableLiveData<Map<String, PostureResult>> getPostureLiveData() {
        return postureLiveData;
    }

    public MutableLiveData<com.example.poseexercise.data.ExerciseAnalysisResult> getAnalysisLiveData() {
